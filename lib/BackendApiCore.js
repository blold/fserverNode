...
class BackendApiCore {
  ...
  _generateUnifiedOrderSignedDictSync(outTradeNo, notifyUrl, nonceStr, body, totalFeeCents, tradeType, attach, options) {
    const instance = this;
  ...
  _generateUnifiedOrderXmlStrSync(outTradeNo, notifyUrl, nonceStr, body, totalFeeCents, tradeType, attach,  options) {
    const instance = this;
    const signedDict = instance._generateUnifiedOrderSignedDictSync(outTradeNo, notifyUrl, nonceStr, body, totalFeeCents, tradeType, attach, options);
    console.log('---- signedDict ----')
    console.log(signedDict)
    console.log('---- signedDict End ----')
    const wholeObj = {
      xml: signedDict,
    };
